...
def create_app(config_name):
    ...
    from .business.account import account as account_blueprint
    app.register_blueprint(account_blueprint, url_prefix='/account')

    from .operational.admin import admin as admin_blueprint
    app.register_blueprint(admin_blueprint, url_prefix='/admin')

    from .business.booking import booking as booking_blueprint
    app.register_blueprint(booking_blueprint, url_prefix='/booking')
    
    from .business.search import search as search_blueprint
    app.register_blueprint(search_blueprint, url_prefix='/search')
    
    from .business.main import main as main_blueprint
    app.register_blueprint(main_blueprint, url_prefix='/dashboard')

    from .business.payment import payment as payment_blueprint
    ...
    from .business.public import public as public_blueprint
    ...
    #def site_name():
        ...
        #site_name=LandingSetting.query.order_by(LandingSetting.site_name).first()
        #return
