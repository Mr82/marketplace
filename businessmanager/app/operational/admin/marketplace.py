...
from app import db
from app.operational.admin.forms import MCategoryForm, MCurrencyForm, MShippingMethodForm, MProductForm
...
def marketplace_category_create():
    ...
    currency_exist = MCurrency.query.get(1)
    if currency_exist is None:
        return redirect(url_for('admin.marketplace_currency_create'))
...
def marketplace_product_create():
    ...
    category_exist = MCategory.query.get(1)
    if category_exist is None:
        return redirect(url_for('admin.marketplace_category_create'))
